...
public interface HedwigMessageI {
    String ANY_RECEIVER = "HEDWIG_ANY_PEER";
    String ANONYMOUS = "HEDWIG_ANONYMOUS";
    int SIGNED_MASK = 0x1;
     ...
     * @throws ASAPSecurityException if message could not be encrypted
     */
    boolean isLaterThan(HedwigMessageI message) throws ASAPException, ASAPSecurityException, IOException;
